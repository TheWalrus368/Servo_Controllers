...
{
  new (message_memory) interfaces::srv::MoveServo_Request(_init);
}

void MoveServo_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<interfaces::srv::MoveServo_Request *>(message_memory);
  typed_message->~MoveServo_Request();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember MoveServo_Request_message_member_array[2] = {
  {
    "port",  // name
    ...
    offsetof(interfaces::srv::MoveServo_Request, port),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interfaces::srv::MoveServo_Request, pos),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MoveServo_Request_message_members = {
  ...
  2,  // number of fields
  sizeof(interfaces::srv::MoveServo_Request),
...
{
  return &::interfaces::srv::rosidl_typesupport_introspection_cpp::MoveServo_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces, srv, MoveServo_Request)() {
  return &::interfaces::srv::rosidl_typesupport_introspection_cpp::MoveServo_Request_message_type_support_handle;
}
...
void MoveServo_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) interfaces::srv::MoveServo_Response(_init);
}

void MoveServo_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<interfaces::srv::MoveServo_Response *>(message_memory);
  typed_message->~MoveServo_Response();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember MoveServo_Response_message_member_array[2] = {
  {
    "status",  // name
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interfaces::srv::MoveServo_Response, status),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interfaces::srv::MoveServo_Response, status_msg),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MoveServo_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(interfaces::srv::MoveServo_Response),
...
{
  return &::interfaces::srv::rosidl_typesupport_introspection_cpp::MoveServo_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces, srv, MoveServo_Response)() {
  return &::interfaces::srv::rosidl_typesupport_introspection_cpp::MoveServo_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers MoveServo_service_members = {
  ...
  // see get_service_type_support_handle<interfaces::srv::MoveServo>()
...
get_service_type_support_handle<interfaces::srv::MoveServo>()
{
  ...
  auto service_type_support =
    &::interfaces::srv::rosidl_typesupport_introspection_cpp::MoveServo_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces, srv, MoveServo)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<interfaces::srv::MoveServo>();
}
